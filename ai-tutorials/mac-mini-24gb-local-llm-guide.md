...
具体某个模型在某个量化档下要吃多少，不用手算——用本站的[大模型显存计算器](/zh/tools/llm-vram-calculator)选模型和量化档直接出数，比如 [27B 模型需要多少显存](/zh/tools/llm-vram-calculator/gemma-3-27b)这类问题一键可查（含 KV cache 随上下文长度的增量）。
